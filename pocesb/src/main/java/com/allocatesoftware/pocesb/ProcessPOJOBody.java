...
public class ProcessPOJOBody implements Processor {
	
	private static final transient Logger LOG = LoggerFactory.getLogger(ProcessPOJOBody.class);
	...
	public void process(Exchange exchange) throws Exception {
        ...
        exchange.getOut().setBody(msgList.get(0));
